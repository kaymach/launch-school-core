...
# can't get the floating point to work below

# MILES_TO_KILOMETERS_PER_HOUR =
#   '%<miles>d PUSH 1.609 MULT PRINT'
# Minilang.new(format(MILES_TO_KILOMETERS_PER_HOUR, miles: 100)).eval
# # 212
# Minilang.new(format(MILES_TO_KILOMETERS_PER_HOUR, miles: 0)).eval
# # 32
# Minilang.new(format(MILES_TO_KILOMETERS_PER_HOUR, miles: 40)).eval
# # -40
